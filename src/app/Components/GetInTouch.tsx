...
const GetInTouch = () => {
  return (
    <div>
      ...
      <div className="bg-cover bg-center h-96 items-center flex flex-col pt-12 mt-12 pl-12" style={{ backgroundImage: `url(${'https://www.tetris-db.com/wp-content/uploads/2021/04/cta.jpg'})` }}>
