      ...
      <nav className="bg-white border-gray-200 py-4 dark:bg-black">
        ...
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-12 mx-auto">
          <a href="#" className="flex flex-col items-center">
            {/* <Image src="https://www.svgrepo.com/show/499962/music.svg" className="h-6 mr-3 sm:h-9" alt="Landwind Logo"/> */}
            <span className="self-center text-5xl font-bold whitespace-nowrap text-white">
              tetris
            </span>
            <span className="pl-6 self-center text-sm whitespace-nowrap text-white">
              design*build
            </span>
          </a>
...
<a href="#"> <div tabIndex={0} role="button" className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">About us</div></a>
...
<div className="dropdown dropdown-hover">
<a href="#"> <div tabIndex={0} role="button" className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Services</div></a>
  <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 w-52">
    <li><a>Item 1</a></li>
    <li><a>Item 2</a></li>
  </ul>
...
<div className="relative">
        ...
        {searchOpen && (
          <div className="relative navbar-transition">
            <input
              type="text"
              className="border border-gray-300 rounded-md px-3 py-2 pl-8 focus:outline-none focus:border-indigo-500"
              placeholder="Search..."
            />
            <div
